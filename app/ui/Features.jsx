...
const features = [
  {
    ...
    desc:"TechCraze Technologies: Learn blockchain online at your own speed, with courses suitable for all skill levels.",
    logo:<BookOpenText size={40} color='blue' className='flex items-center' />
  },
  {
    id:2,
    name:"Video Tutorials",
    desc:"Learn blockchain at your own speed and on your own time with our online video tutorials.",
