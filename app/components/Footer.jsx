...
const address = [
  ...
  {
    id:1,
    name:"5/105, 1nd floor, pillayar koil street,perumal koil arch,chennai - 600100.",
    logo:<MapPin />
  },
]
    ...
    <footer className='px-6 pt-10 pb-10 font-sans text-center text-white bg-blue-900 md:px-20'>
      <div className='grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4'>
        <div className='w-full pr-4 text-left'>
          ...
          <p className='pt-2'>TECHCRAZE TECHNOLOGIES is an excellent online learning facility with a diverse choice of courses.</p>
        </div>
